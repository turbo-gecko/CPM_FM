...
class SerialConfigDialog:
    def __init__(self, parent, app):
        ...
        # Terminal Comm Port
        ttk.Label(port_frame, text="Terminal Comm Port:").grid(row=0, column=0, padx=5, pady=2, sticky="w")
        ...
        self.term_port_combo.set('COM1')
        
        # Transfer Comm Port
        ttk.Label(port_frame, text="Transport Comm Port:").grid(row=1, column=0, padx=5, pady=2, sticky="w")
        ...
        self.trans_port_combo.set('COM1')

        # Speed
        ttk.Label(port_frame, text="Speed:").grid(row=2, column=0, padx=5, pady=2, sticky="w")
        ...
        # Data bits
        ttk.Label(port_frame, text="Data:").grid(row=3, column=0, padx=5, pady=2, sticky="w")
        ...
        ttk.Label(port_frame, text="Parity:").grid(row=4, column=0, padx=5, pady=2, sticky="w")
        ...
        # Stop bits
        ttk.Label(port_frame, text="Stop Bits:").grid(row=5, column=0, padx=5, pady=2, sticky="w")
        ...
        # Flow Control
        ttk.Label(port_frame, text="Flow Control:").grid(row=6, column=0, padx=5, pady=2, sticky="w")
    ...
    def on_ok(self):
        ...
        print(
            f"Settings: {self.term_port_var.get()}, {self.speed_var.get()}, {self.data_var.get()}")
