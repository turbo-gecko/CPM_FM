...
_263/476 requirements have a verifying test; 213 untested; 0 stale tag(s)._
...
| FR-176 | `tests/test_gui_smoke.py:test_close_image_resets_remote_pane`, `tests/test_gui_smoke.py:test_connect_refused_while_remote_image_mounted`, `tests/test_gui_smoke.py:test_copy_to_host_copies_out_of_remote_image`, `tests/test_gui_smoke.py:test_copy_to_remote_image_validates_8_3`, `tests/test_gui_smoke.py:test_copy_to_remote_stages_into_remote_mounted_image`, `tests/test_gui_smoke.py:test_open_remote_after_host_restores_host_pane`, `tests/test_gui_smoke.py:test_remote_group_title_and_drive_combo_reflect_image`, `tests/test_gui_smoke.py:test_remote_mount_lists_image_in_remote_pane`, `tests/test_gui_smoke.py:test_remote_mount_refused_while_connected` |
