...
_298/499 requirements have a verifying test; 201 untested; 0 stale tag(s)._
...
| DR-051 | `tests/test_cpm_parser.py:test_drive_prompt_user_extracts_zcpr_area`, `tests/test_cpm_parser.py:test_drive_prompt_user_none_on_plain_cpm22_prompt`, `tests/test_cpm_parser.py:test_drive_prompt_user_none_when_no_prompt`, `tests/test_cpm_parser.py:test_drive_prompt_user_reads_first_prompt`, `tests/test_user_area.py:test_connect_probe_reads_back_zcpr_area` |
...
| FR-181 | `tests/test_user_area.py:test_change_user_area_tracks_selection_when_disconnected` |
| FR-182 | `tests/test_user_area.py:test_apply_remote_user_area_noop_when_already_in_area`, `tests/test_user_area.py:test_apply_remote_user_area_noop_when_command_blank`, `tests/test_user_area.py:test_apply_remote_user_area_sends_configured_command`, `tests/test_user_area.py:test_change_drive_applies_user_area_before_listing`, `tests/test_user_area.py:test_default_settings_include_user_area_cmd` |
| FR-183 | `tests/test_user_area.py:test_apply_transfer_user_area_noop_when_already_in_area`, `tests/test_user_area.py:test_apply_transfer_user_area_noop_when_command_blank`, `tests/test_user_area.py:test_apply_transfer_user_area_sets_area_then_settles`, `tests/test_user_area.py:test_change_drive_applies_user_area_before_listing`, `tests/test_user_area.py:test_no_response_message_names_user_area_when_nonzero` |
| FR-184 | `tests/test_user_area.py:test_apply_remote_user_area_noop_when_already_in_area`, `tests/test_user_area.py:test_apply_remote_user_area_sends_configured_command`, `tests/test_user_area.py:test_apply_transfer_user_area_noop_when_already_in_area`, `tests/test_user_area.py:test_change_user_area_tracks_selection_when_disconnected`, `tests/test_user_area.py:test_connect_probe_defaults_area_to_zero_on_cpm22`, `tests/test_user_area.py:test_connect_probe_reads_back_zcpr_area` |
| FR-185 | `tests/test_disk_image/test_write.py:test_write_read_preserves_distinct_user_areas`, `tests/test_user_area.py:test_extract_preserves_area_and_disambiguates_duplicates`, `tests/test_user_area.py:test_open_image_preserves_area_map_end_to_end` |
